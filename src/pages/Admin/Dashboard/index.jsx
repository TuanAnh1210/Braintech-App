            ...
            <div className={cx(' body content bg-slate-900 pt-[60px] px-[30px] min-h-[950px] ')}>
                        ...
                        <div className={cx('grid grid-cols-4 gap-[20px]  ')}>
                            <div className={cx(' card-stats relative p-[5px]  ')}>
                                <div className={cx(' card-header-warning static   ')}>
                                    <div
                                        className={cx(
                                            'card-icon bg-[#f5700c] absolute top-0 left-0  w-[86px] h-[86px] text-center ml-[20px] p-[25px] rounded ',
                                        )}
                                    >
                                        <svg
                                            className={cx('text-white-500', 'bi bi-people-fill')}
                                ...
                                <div className={cx('bg-[#1f283e] h-[90%] mt-[20px] pt-[20px] rounded w-full')}>
                                    <div className={cx('ml-[65%]')}>
                                        ...
                                        <h3 className={cx('text-[#6c757d] ml-[65%]')}>0</h3>
                                    </div>
                                    <div className={cx('mt-[20px] mx-[20px]  border-t-2 border-[#6c757d] ')}>
                                        <div className={cx(' flex flex-row pt-[10px] text-center items-center')}>
                                            ...
                                            <a
                                                href="#pablo"
                                                className={cx('warning-link ml-[10px] text-[#6c757d] text-[15px]')}
                                            >
                                                Tổng học viên
                                            </a>
                                        </div>
                            ...
                            <div className={cx(' card-stats relative p-[5px]  ')}>
                                <div className={cx(' card-header-warning static   ')}>
                                    <div
                                        className={cx(
                                            'card-icon bg-[#288c6c] absolute top-0 left-0  w-[86px] h-[86px] text-center ml-[20px] p-[25px] rounded ',
                                        )}
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div className={cx(' card-stats relative p-[5px]  ')}>
                                <div className={cx(' card-header-warning static   ')}>
                                    <div
                                        className={cx(
                                            'card-icon bg-[#d22824] absolute top-0 left-0  w-[86px] h-[86px] text-center ml-[20px] p-[25px] rounded ',
                                        )}
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div className={cx(' card-stats relative p-[5px]  ')}>
                                <div className={cx(' card-header-warning static   ')}>
                                    <div
                                        className={cx(
                                            'card-icon bg-[#029eb1] absolute top-0 left-0  w-[86px] h-[86px] text-center ml-[20px] p-[25px] rounded ',
                                        )}
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                ...
                <div className={cx(' card-stats relative p-[5px] mt-[100px] ')}>
                    <div className={cx(' card-header-warning static   ')}>
                        <div
                            className={cx(
                                'card-icon bg-[#7b1fa2] absolute top-0 left-0  w-[95%] h-[86px] ml-[30px] p-[15px] rounded ',
                            )}
                        >
                            <h4 className={cx('card-title text-white')}>Doanh thu năm 2023</h4>
                            <p className={cx('card-category text-white')}>
                                {' '}
                                Tổng doanh thu: <strong className={cx('totalRevenue test2')}></strong>
                            </p>
                        </div>
                    </div>
